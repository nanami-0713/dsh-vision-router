...
export function apply(ctx, config = {}) {
  ...
  // The 0.1.7 browser no longer exposes settingsScope. Install both halves of
  // the bridge here so the server endpoint and the pre-activation client shim
  // are live before the web bundle evaluates DVR's client plugin.
  installDsh017LocalSettingsTransport(settingsCtx)
